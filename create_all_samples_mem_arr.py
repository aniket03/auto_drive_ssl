...
if __name__ == '__main__':
    ...
    aux_model_file = PAR_WEIGHTS_DIR + 'e1_simclr_auto_aux_epoch_30'
    main_model_file = PAR_WEIGHTS_DIR + 'e1_simclr_auto_main_epoch_30'
    all_samples_mem_file = PAR_ACTIVATIONS_DIR + 'e1_simclr_auto_activ_epoch_30.npy'
